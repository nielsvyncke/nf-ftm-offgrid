...
Examples:
  ...
  $0 --env <env_name> --bundle_dir /path/to/bundle --data_dir /path/to/data --fold 0 --batch_size 8
...
SLURM Submission Example:
  To submit this script as a SLURM job with customized options:
    sbatch --job-name=train_glas_fold0 train.sh --conda_path /path/to/conda --env <env_name> --data_dir /path/to/data --fold 0 --batch_size 8
